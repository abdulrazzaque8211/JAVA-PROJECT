...
<body>
	...
	<table align="center" border="1">
		...
		<tr>
			...
			<td><a href="#"
				onclick="update(<%=userBean.getId()%>,'<%=userBean.getUname()%>','<%=userBean.getPwd()%>','<%=userBean.getEmail()%>','<%=userBean.getContact()%>','<%=userBean.getAge()%>')">Update</a></td>
	...
	function update(id,name, password,email,contact,age) {
